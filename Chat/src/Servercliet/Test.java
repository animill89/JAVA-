...
public class Test implements Runnable {
	...
	public Test(Socket s, DataInputStream br, DataOutputStream ds, List<Test> clients){
		this.s = s;
		dis=br;
		dos=ds;
		beConnected=true;
	...
	public void sendUserList() {
		...
		nameList.append(OutPut.USER_LIST);
		for (int i = 0; i < clients.size(); i++) {
			Test c = clients.get(i);
	...
	public void run() {
		try{ 
			...
			welMsg.append(OutPut.WELCOME_MESSAGE).append(name).append("********");
